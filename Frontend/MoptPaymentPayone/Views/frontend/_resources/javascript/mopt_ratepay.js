...
function ratepayRateCalculatorAction(mode, paymentMethod, url)
{
    ...
    amount = document.getElementById('mopt_payone__fin_ratepay_installment_amount').value;
    ratePayshopId = document.getElementById('ratePayShopId').value;
    ratePayCurrency = document.getElementById('ratePayCurrency').value;
    dob = document.getElementById('mopt_payone__fin_ratepay_installment_birthdaydate').value;
    dueDate = '';
    calcMethod = '';
    calcValue = '';
    notification = '';

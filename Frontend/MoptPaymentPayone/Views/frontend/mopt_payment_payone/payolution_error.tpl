...
<div id="center" class="grid_13">
  ...
  <div class="actions">
    ...
    <a class="btn" href="{url controller=checkout action=shippingPayment forceSecure}" title="{s namespace='frontend/MoptPaymentPayone/payment' name=PaymentLinkChange}Zahlungsart ändern{/s}">

...
<div class="payment--form-group">
    ...
    <input name="moptPaymentData[mopt_payone__giropay_iban]"
           ...
           class="payment--field is--required{if $error_flags.mopt_payone__giropay_iban} has--error{/if} moptPayoneIban" />
    ...
    <input name="moptPaymentData[mopt_payone__giropay_bic]"
           ...
           class="payment--field is--required{if $error_flags.mopt_payone__giropay_bic} has--error{/if} moptPayoneBic" />
</div>

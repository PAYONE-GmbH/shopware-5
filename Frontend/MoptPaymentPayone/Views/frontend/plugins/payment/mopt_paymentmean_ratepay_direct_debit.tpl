...
-->
    <input name="moptPaymentData[mopt_payone__ratepay_direct_debit_iban]"
           ...
           class="payment--field is--required{if $error_flags.mopt_payone__ratepay_direct_debit_iban} has--error{/if} moptPayoneIban" />
    ...
    <input name="moptPaymentData[mopt_payone__ratepay_direct_debit_bic]"
           ...
           class="payment--field is--required{if $error_flags.mopt_payone__ratepay_direct_debit_bic} has--error{/if} moptPayoneBic" />

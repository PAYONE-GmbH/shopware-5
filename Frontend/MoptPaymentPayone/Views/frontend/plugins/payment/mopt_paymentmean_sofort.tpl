...
<div class="payment--form-group">
    ...
    {else}
        ...
        <input name="moptPaymentData[mopt_payone__sofort_iban]"
               ...
               class="payment--field is--required{if $error_flags.mopt_payone__sofort_iban} has--error{/if} moptPayoneIban" />
        ...
        <input name="moptPaymentData[mopt_payone__sofort_bic]"
               ...
               class="payment--field is--required{if $error_flags.mopt_payone__sofort_bic} has--error{/if} moptPayoneBic" />
        {/if}

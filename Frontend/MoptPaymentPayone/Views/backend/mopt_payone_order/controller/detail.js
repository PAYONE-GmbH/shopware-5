...
Ext.define('Shopware.apps.Order.controller.MoptPayoneDetail', {
  ...
  onMoptPayoneDebitPositions: function(order, grid, options) {
    ...
    if (positionIds) {
      ...
      var isSecuredPayment = /mopt_payone__fin_payone_secured_installment/.test(paymentName) || /mopt_payone__fin_payone_secured_invoice/.test(paymentName) || /mopt_payone__fin_payone_secured_directdebit/.test(paymentName);
      console.log('isSecuredPayment:' + isSecuredPayment);

...
//{block name="backend/mopt_payone_transaction_log/controller/log"}
Ext.define('Shopware.apps.MoptPayoneTransactionLog.controller.Log', {
    /**
	...
	*/
	init: function() {
		...
		me.control({
			'moptPayoneTransactionLogMainList toolbar combobox': {

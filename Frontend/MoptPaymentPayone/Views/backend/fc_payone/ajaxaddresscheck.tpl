    ...
    <div class="col-md-12">
        ...
        <div class='col-md-9'>
            <form role="form" id="ajaxaddresscheckform" class="form-horizontal">
                ...
                {include file='backend/fc_payone/include/input_text.tpl' id='adresscheckMinBasket' label="{s name="fieldlabel/maxBasket"}Minimaler Warenwert{/s}" pattern='^[,.0-9]*' minlength="1" maxlength="255"}

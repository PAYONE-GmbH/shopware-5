    ...
    <div class="col-md-9">
        ...
        <div class='col-md-9'>
            <form role="form" id="googlepayform" class="form-horizontal">
                ...
                {include file='backend/fc_payone/include/input_text.tpl' id='googlepayCountryCode' label="{s name="fieldlabel/googlepayCountryCode"}Google Pay Acquirer Ländercode{/s}" pattern='^[_ .+-?,:;"!@#$%^&*ÄÖÜäöüa-zA-Z0-9]*' content="{s name="fieldlabelhelp/googlepayCountryCode"}Google Pay Acquirer Ländercode{/s}"}

...
{block name="resources/javascript" append}  
    ...
    <script type="text/javascript">
        ...
        function requestDetailsFormatter(value) {
            return '<a data-placement="left" data-toggle="popover" data-trigger="focus" href="#" data-content="' + value + '" title="Details" data-html="true" class="">requestDetails</a>';
        }

        function responseDetailsFormatter(value) {
            return '<a data-placement="left" data-toggle="popover" data-trigger="focus" href="#" data-content="' + value + '" title="Details" data-html="true" class="">responseDetails</a>';
        }

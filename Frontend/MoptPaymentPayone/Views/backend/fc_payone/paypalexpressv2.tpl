...
{block name="content/main"}
    ...
    <div class="col-md-12">
        ...
        <div>
            {s name="global-form/paypalexpressv2Desc"}Stellen Sie hier die Konfiguration zur Zahlart PayPal Express V2 ein.{/s}
        </div>
        <div class='col-md-12'>
            <form role="form" id="paypalexpressv2form" class="form-horizontal">
                {include file='backend/fc_payone/include/dropdown_payments.tpl'}
                {include file='backend/fc_payone/include/dropdown_yesno.tpl' id='paypalV2ShowButton' label="{s name="fieldlabel/paypalV2ShowButton"}PayPal V2 BNPL Button anzeigen{/s}" pattern="^[0-9]*" content=""}

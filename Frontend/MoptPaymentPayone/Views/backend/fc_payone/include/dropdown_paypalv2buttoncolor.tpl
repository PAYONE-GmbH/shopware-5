...
<div class="form-group has-feedback has-error">
    ...
    <div class="col-md-6">
        <select class="form-control " pattern='{$pattern}' id="{$id}" name="{$id}" aria-describedby="{$id}-status" >
            <option value="gold">{s name="fieldvalue/gold"}Gold{/s}</option>
            <option value="blue">{s name="fieldvalue/blue"}Blau{/s}</option>
            <option value="silver">{s name="fieldvalue/silver"}Silber{/s}</option>

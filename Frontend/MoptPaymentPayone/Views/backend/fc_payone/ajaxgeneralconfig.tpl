        ...
        <div class='col-md-12'>
            <form role="form" id="ajaxgeneralconfigform" class="form-horizontal">
                ...
                <div class="form-group has-feedback has-error  menu-level-standard  menu-level-experte">
                    ...
                    <label for="paydirektOrderSecured" class="text-left col-md-3 control-label">{s name="fieldlabel/paydirektOrderSecured"}Gesicherte Vorbestellung{/s}</label>
                    <div class="col-md-6">
                ...
                <div class="form-group has-feedback has-error  menu-level-standard  menu-level-experte">
                    <img src="{link file='backend/_resources/images/information.png'}" data-toggle="popover" title="PAYONE Hilfe" data-content="{s name="fieldlabelhelp/paydirektPreauthorizationValidity"}Gewünschter Garantiezeitraum (maximal 15 Kalendertage) für eine gesicherte Vorbestellung (ORDER_SECURED){/s}">
                    <label for="paydirektPreauthorizationValidity" class="text-left col-md-3 control-label">{s name="fieldlabel/paydirektPreauthorizationValidity"}Garantiezeitraum{/s}</label>
                    <div class="col-md-6">

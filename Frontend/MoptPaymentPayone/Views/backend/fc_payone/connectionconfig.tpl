    ...
    <div class="col-md-12">
        ...
        <div class='col-md-12'>
            <form id="connectionconfigform" class="form-horizontal needs-validation" novalidate>
                ...
                {include file='backend/fc_payone/include/input_text.tpl' id='apiKey' label="{s name="fieldlabel/apiKey"}API-Schlüssel{/s}" pattern='^[_ .+-?,:;"!@#$%^&*ÄÖÜäöüa-zA-Z0-9`´€]*' minlength="1" maxlength="100" content="{s name="fieldlabelhelp/apiKey"}API-Schlüssel des zu verwendenden Zahlungsportal{/s}"}

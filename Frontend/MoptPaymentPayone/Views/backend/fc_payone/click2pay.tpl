...
{block name="content/main"}
    ...
    <div class="col-md-9">
        ...
        <div class='col-md-9'>
                {include file='backend/fc_payone/include/input_text.tpl' id='click2payButtonStyle' label="{s name="fieldlabel/click2payButtonStyle"}Button Stil{/s}" pattern='^[_ .+-?,:;"!@#$%^&*ÄÖÜäöüa-zA-Z0-9]*' content="{s name="fieldlabelhelp/click2payButtonStyle"}Button Stil{/s}" placeholder="OUTLINED"}
                {include file='backend/fc_payone/include/input_text.tpl' id='click2payButtonTextCase' label="{s name="fieldlabel/click2payButtonTextCase"}Button Text Stil{/s}" pattern='^[_ .+-?,:;"!@#$%^&*ÄÖÜäöüa-zA-Z0-9]*' content="{s name="fieldlabelhelp/click2payButtonTextCase"}Button Text Stil{/s}" placeholder="capitalize"}

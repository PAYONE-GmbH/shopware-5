<div class="debit">
  <div class="form-group {if $error_flags.mopt_payone__klarna_telephone}has-error{/if}">
      <label for="mopt_payone__klarna_telephone" class="col-lg-4 control-label">
      ...
      <div class="col-lg-6">
          <input name="moptPaymentData[mopt_payone__klarna_telephone]" type="text" id="mopt_payone__klarna_telephone" 
                 value="{$form_data.mopt_payone__klarna_telephone|escape}" class="form-control"/>
      </div>
  </div>
  
  <div class="form-group {if $error_flags.mopt_payone__klarna_birthday 
              || $error_flags.mopt_payone__klarna_birthmonth 
              || $error_flags.mopt_payone__klarna_birthyear}has-error{/if}">
      <label for="mopt_payone__klarna_birthday" class="col-lg-4 control-label">
        {s namespace='frontend/MoptPaymentPayone/payment' name='birthdate'}Geburtsdatum{/s}
      </label>

      <div class="col-lg-6">
        <select style="width:auto;" id="mopt_payone__klarna_birthday" 
                name="moptPaymentData[mopt_payone__klarna_birthday]" class="form-control">
				<option value="">--</option>	
            ...
            selected{/if}>{$smarty.section.birthdate.index}
				...
				<select "style="width:auto;" id="mopt_payone__klarna_birthmonth"  
          name="moptPaymentData[mopt_payone__klarna_birthmonth]" class="form-control">
				<option value="">-</option>	
          ...
          selected{/if}>{$smarty.section.birthmonth.index}</option>
				...
				<select style="width:auto;" id="mopt_payone__klarna_birthyear"  
                name="moptPaymentData[mopt_payone__klarna_birthyear]" class="form-control">
				<option value="">----</option>	
  ...
  <div class="form-group {if $error_flags.mopt_payone__klarna_agreement}has-error{/if}">
      <div class="col-lg-6">
        <input name="moptPaymentData[mopt_payone__klarna_agreement]" type="checkbox" 
         id="mopt_payone__klarna_agreement" {if $form_data.mopt_payone__klarna_agreement eq "on"}
         checked{/if} class="text {if $error_flags.mopt_payone__klarna_agreement}instyle_error{/if}" style="width:auto;"/>

...
{include file=\"string:{config name = emailfooterplain}\"}\', \'\', 0, \'\', 3, NULL, 0);
    ...
    /**
     * Checks if click2pay columns are present and removes
     * columns if present.
     *
     * @return void
     * @throws Zend_Db_Adapter_Exception
     * @throws Zend_Db_Statement_Exception
     */
    public function checkAndRemoveClick2PayOptions()
    {
